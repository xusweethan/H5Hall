...
public class RoundImageView extends ImageView{
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mImageViewWidth = a.getDimensionPixelSize(R.styleable.RoundImageView_default_width, DEFAULT_WIDTH);
        mImageViewHeight = a.getDimensionPixelSize(R.styleable.RoundImageView_default_height, DEFAULT_HEIGHT);
    ...
    private Bitmap getBitmapFromDrawable(Drawable drawable) {
        ...
        if (drawable instanceof BitmapDrawable) {
        	...
        	bitmap = Bitmap   
                    ...
                    drawable.setBounds(0, 0, mImageViewWidth,   
                    mImageViewHeight);   
